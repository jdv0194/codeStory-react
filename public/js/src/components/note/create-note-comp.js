...
export default class Create_note extends React.Component {
  ...
  addNote = e => {
    e.preventDefault();
    let title = $('.c_n_middle input[type="text"]').val(),
        ...
        <FadeIn duration="300ms">
          <form onSubmit={this.addNote}>
            <div className="c_n_header modal_header">
              <span className="title">Create a code</span>
              <Goto />
            </div>
            ...
            <div className="c_n_bottom modal_bottom">
              <a href="#" className="c_n_cancel sec_btn" onClick={this.back}>
                Back
              </a>
              <input
                type="submit"
                className="c_n_add pri_btn"
                value="Add note"
              />
            </div>
          </form>
